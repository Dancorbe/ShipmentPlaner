...
struct qt_meta_stringdata_CLASSDlgOrdersENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDlgOrdersENDCLASS = QtMocHelpers::stringData(
    "DlgOrders",
    "on_btnClose_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDlgOrdersENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DlgOrders::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSDlgOrdersENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDlgOrdersENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDlgOrdersENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DlgOrders, std::true_type>,
...
void *DlgOrders::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDlgOrdersENDCLASS.stringdata0))
